...
## 🦖(한국어) FG-Clip 실습!!
> **FG-CLIP** : Segment Everything Everywhere All At Once
...
```
tensor([[9.6813e-01, 3.2603e-05, 3.1839e-02]], device='cuda:0',
...
![catcam](https://github.com/user-attachments/assets/e72f0746-0082-4696-a097-9197bbc88f93) 과 같이 고양이 부분이 활성화됩니다!!

같은 그림에서 아래와 같이 테스트를 해보았어요!
