---
layout: post
title: "Meta에서 Llama 4 모델 공개! 멀티모달의 새로운 시대가 열리다"
author: [DrFirst]
date: 2025-04-07 11:00:00 +0900
categories: [Multimodal AI, Open Source Model, LLM]
tags: [Llama, Llama 4, Multimodal AI, Large Language Model, Meta AI, Hugging Face, Transformers, MoE, AI 모델]
...
# Meta에서는 25년 4월 5일!!!! 차세대 멀티모달 AI 모델, Llama 4를 공개했습니다! 🦙🚀
...
> iRoPE는 무었인가!!
> **iRoPE**는 **"interleaved Rotary Position Embedding"**의 줄임말로,
> 여기서 **"i"는 interleaved**, 즉 **교차된(attention) 레이어 구조**를 의미하고,
...
- SFT → 온라인 RL → DPO의 **3단계 파이프라인**
- 쉬운 문제 제거 → 중~상 난이도 중심 학습
- 지속적인 RL로 학습 성능 점진적 향상
...
- **Prompt Injection** (시스템 지침을 덮어쓰는 입력)
- 명시적, 암시적 공격 모두 대응 가능
...
🦙 **LlamaCon 2025**가 오는 **4월 29일** 개최 예정!  
여기서 Behemoth의 추가 정보, 멀티모달 툴킷, 성능 벤치마크 등 더 많은 정보가 발표될 예정입니다.
