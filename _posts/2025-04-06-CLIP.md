...
tags: [CLIP, Contrastive Learning, Multimodal AI, OpenAI, Zero-shot Learning, Image-Text Matching, Vision Transformer, Deep Learning, Representation Learning,ICML, ICML2021, OpenAI]
lastmod : 2025-04-05 11:00:00
sitemap :
  changefreq : weekly
  priority : 0.9
---
...
>> 이때!! 황금=텍스트, 비트코인=이미지 의 예시이고, 동일한 수직선 $가 벡터입니다!!
---
...
L = -\log \left( 
  \frac{
    \exp\left( \frac{\text{sim}(x, y^+)}{\tau} \right)
  }{
    \sum_i \exp\left( \frac{\text{sim}(x, y_i)}{\tau} \right)
  }
\right)
$$
