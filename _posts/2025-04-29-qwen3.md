---
layout: post
title: "Qwen 3 공개 - 더 강력해진 오픈소스 LLM"
author: [DrFirst]
...
## 🚀 Qwen 3 공개!
_Qwen3 GitHub와 공식 블로그를 참고하여_

📖 **프로젝트명**: Qwen 3  
🏢 **개발사**: Alibaba Cloud  
🎯 **추천 대상**: 오픈소스 LLM에 관심 있는 연구자, 엔지니어, 개발자  
🌟 **한줄 요약**: 딥식을 넘어서는 중국 대표의 오픈소스 모델!!?  
...
A. Pre-training : **수백억 단어**로 학습된 방대한 데이터셋 
...
B. Post-training : **Hybrid Thinking Modes**를 위한 4단계 학습방법!!!
 ...
 > 내용이 장황하게 나와있는데,, 실질적으로 어떻게 작용하는지는 세부적인 공부가 필요해보이네요~!!  
...
금일 공개된 모델로 사실, 아직 직접 모델을 코드로 돌려보지도 못했고 성능도 직접 다른모델과 많이 비교해보지 못했습니다!.  
그러나!! 이렇게 빠른 주기로 새로운 모델을 오픈하며,  
새로운 기술들을 적용하는 속도를 보면  
정말 많은 노력과 투자가 있었겠구나 느끼게 됩니다!!
이런 모델이 Opensource임에 감사하며!!  
